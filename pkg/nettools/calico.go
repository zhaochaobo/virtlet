...
// namespace.
func FixCalicoNetworking(netConfig *cnicurrent.Result, calicoSubnetSize int, getDummyNetwork func(string, string, string) (*cnicurrent.Result, string, error), podID, podName string, podNs string) error {
